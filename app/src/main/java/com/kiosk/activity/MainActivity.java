...
import com.kiosk.Utils;
import com.kiosk.crt.SimplePassportReader;
...
public class MainActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    String intentCardType = Arrays.toString(cardTypes);
  ...
  private void initLog() {
    String LogPath = Objects.requireNonNull(getExternalFilesDir(null)).getPath();
  ...
  private String getCardType() {
    return spinnerCardType.getSelectedItem().toString();
  }
